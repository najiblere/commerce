...
function CalenderContent({isFooter=true}) {
              ...
              <div className='w-100'>
                <Fade bottom>
                  ...
                  <div className='px-5 text-left'>
                    <>
                        <p className='fs-2 fw-700p px-5'>Calender </p>
                        <p className='fs-5 fw-200p px-5'>Updated {new Date().getDate() + '-' + new Date().getMonth()+' '+new Date().getFullYear()}</p>
                    </>
                  </div>
                  <p className='fs-5 fw-200p px-5 text-center'>calender items not found</p>

                  <div className='my-3 text-center'>
                        <p className='fs-2 fw-900p btn' style={{background: '#00f900'}}><CalendarOutlined/> View Full Calender</p>
                    </div>
                  </div>
                </Fade>
              </div>
